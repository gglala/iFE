...
function getPosition(element) {
    ...
    // documentElement 对应的是 html 标签，而 body 对应的是 body 标签。这里都是 0
...
function ajax(url, options) {
    ...
    if (options.type == 'GET') {
        ...
        // 设置 Content-type, 表示提交的数据的类型
        // 默认类型是 'application/x-www-form-urlencoded'
        // 其他类型还有：multipart/form-data、application/json、text/xml等
        // https://www.cnblogs.com/fengff/p/10843728.html
